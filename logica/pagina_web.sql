...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-08-2017 a las 00:51:27
...
(3, 1, 'Mecanico', 'Se solicita mecánico para el área de maquinas textiles.', 9898877676, 'AV LOS 4 CAMINOS', '2017-08-12'),
...
(1, 1, 'Curso de Bordado', 'En este  curso de bordado básico vamos a aprender a realizar puntadas esenciales en el bordado, mediante pequeños vídeos con explicaciones escritas y sin audio, muy faciles de seguir.\nLas puntadas que vamos a ver en este curso son:\nEl cordoncillo.\nLa cadeneta.\nRelleno de punto de arroz.\nRelleno de cordoncillo.', '2017-08-01', 'slide-2.jpg'),
...
--
-- Indices de la tabla `bolsa_formulario`
--
...
--
ALTER TABLE `aspirantes`
  MODIFY `Id_aspi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `bolsa_formulario`
--
ALTER TABLE `bolsa_formulario`
...
--
ALTER TABLE `bolsa_trabajo`
  MODIFY `Id_bolsa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
