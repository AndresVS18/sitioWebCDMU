...
<body>
    ...
    <div class="row">
        <div class="box">
            <div class="col-lg-12">
                <hr>
                <h2 class="intro-text text-center">Oportunidades
                    <strong>de Negocio</strong>
                </h2>
                <hr>
                <h3 class="text-center">Si dese Publicar una Oportunidad de Negocio, favor de completar el siguiente formato</h3>
                <form role="form">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4">
                            <label>Datos de la Publicacion</label>
                        ...
                        <div class="form-group col-lg-4">
                            <label>Datos del Afiliado</label>
                            <input type="tel" class="form-control">
                        </div>
                        <div class="form-group col-lg-4">
                            <label>Vigencia de la Publicacion</label>
                            <input type="tel" class="form-control">
                        </div>
                        <div class="form-group col-lg-4">
